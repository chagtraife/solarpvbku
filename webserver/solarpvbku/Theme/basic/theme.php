...
<html>
    <head>
        ...
        <title>Solar.pv.bku - <?php echo $route->controller.' '.$route->action.' '.$route->subaction; ?></title>
        <link rel="shortcut icon" href="<?php echo $path; ?>Theme/<?php echo $theme; ?>/Logo_hcmut.png" />
        <meta name="apple-mobile-web-app-capable" content="yes">
        <meta name="apple-mobile-web-app-status-bar-style" content="black">
        <link rel="apple-touch-startup-image" href="<?php echo $path; ?>Theme/<?php echo $theme; ?>/Logo_hcmut.png">
        <link rel="apple-touch-icon" href="<?php echo $path; ?>Theme/<?php echo $theme; ?>//Logo_hcmut.png">
...
?>
    ...
    <body>
        ...
        <div id="emoncms-navbar" class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                    ...
                    <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
                        <img src="<?php echo $path; ?>Theme/<?php echo $theme; ?>/Logo_hcmut.png" style="width:28px;"/>
                    </button>
        ...
        <div id="footer">
            <?php echo _('Design by '); ?>
            <a href="https://www.facebook.com/thang.nguyenngoc.7524">thang.nguyenngoc1996@gmail.com</a>
